...
# Copying Files with Numeric Characters in Filenames

The objective of this code is to check the existence of a source directory, filter files from that directory and its subdirectories whose filenames contain at least one numeric character (0-9), and copy those files to a specified destination folder.
...
if not os.path.exists(source_directory):
    ...
    file_paths = glob(f'{source_directory}/**/*[0-9]*.*',recursive=True)
...
```
    ...
    Total number of files copied: 20
...
<table border="1" class="dataframe">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>.txt</td>
      <td>D:/Copy/Umer_Saeed\BH\20242809.txt</td>
    </tr>
    <tr>
      <th>19</th>
      <td>g.txt</td>
    ...
    <tr>
      <th>31</th>
      <td>1981-03-08.txt</td>
      <td>0</td>
      <td>2024-09-28 11:36 PM</td>
      <td>.txt</td>
      <td>D:/Copy/Umer_Saeed\Umer\1981-03-08.txt</td>
    </tr>
    <tr>
      <th>32</th>
      <td>19980802_UmerSaeed.xlsx</td>
...
<table border="1" class="dataframe">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>2024-09-30 08:42 PM</td>
      <td>.txt</td>
      <td>D:/Copy/Ali_Saeed\1981-03-08.txt</td>
    </tr>
    <tr>
      <th>6</th>
      <td>19980802_UmerSaeed.xlsx</td>
    ...
    <tr>
      ...
      <td>2024-09-30 08:42 PM</td>
      <td>.txt</td>
      <td>D:/Copy/Ali_Saeed\20242809.txt</td>
    </tr>
    <tr>
      <th>9</th>
      <td>AS_1234_US.xlsx</td>
...
with pd.ExcelWriter("35_Example.xlsx",date_format = 'dd-mm-yyyy',datetime_format='dd-mm-yyyy') as writer:
