...
This example demonstrates how to copy files from a source directory and its subdirectories to a destination directory based on a specific filename prefix (**US** in this case). Here's a breakdown of the process:
