...
The purpose of this code is to copy files with a suffix of either **"US"** or **"AS"** and a **size smaller than 500KB** from a specified source directory and its subdirectories to a target folder. Here’s a breakdown of its functionality:
