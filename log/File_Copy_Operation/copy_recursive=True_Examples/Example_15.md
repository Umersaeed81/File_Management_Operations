...
This example is focused on copying files from a source directory to a destination directory and its subdirectories based on whether the files contain a specific keyword (in this case, **"US"**) anywhere in their filenames. Here's a detailed summary:
...
if not os.path.exists(source_directory):
    ...
    file_paths = glob(f'{source_directory}/**/*US*.*',recursive=True)
