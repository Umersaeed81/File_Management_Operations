...
This example demonstrates the process of copying files from a source directory and its subdirectories to a destination directory, focusing on files that contain a specific keyword (in this case **"US"**) in their filenames, have a particular file extension (in this case **.xlsx**), and are **smaller than 500KB in size**.
...
with pd.ExcelWriter("29_Example.xlsx",date_format = 'dd-mm-yyyy',datetime_format='dd-mm-yyyy') as writer:
