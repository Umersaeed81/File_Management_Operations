...
if not os.path.exists(source_directory):
    ...
    file_paths = glob(f'{source_directory}/**/*.*',recursive=True)
...
```
    ...
    Total number of files copied: 40
...
with pd.ExcelWriter("01_Example.xlsx",date_format = 'dd-mm-yyyy',datetime_format='dd-mm-yyyy') as writer:
