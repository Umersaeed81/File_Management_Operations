...
# Copying Recently Modified Files Within the Last 5 Day

The objective of this code is to filter files only from the source directory (excluding subdirectories) that were modified within the last 5 days and copy those files to a specified destination folder.
