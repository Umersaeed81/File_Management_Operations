...
file_paths = ["D:/Copy/Umer_Saeed/Test.xlsx", "D:/Copy1/Ahmed_Saeed/Test.xlsx"]
...
file_info_source_directory0 = get_file_info('D:/Copy/Umer_Saeed')
file_info_source_directory1 = get_file_info('D:/Copy1/Ahmed_Saeed')
file_info_destination_folder = get_file_info('D:/Copy/Ali_Saeed')
```


```python
file_info_source_directory0
```
...
<table border="1" class="dataframe">
  ...
  <tbody>
    <tr>
      ...
      <td>2024-08-11 10:53 AM</td>
      <td>.xlsx</td>
      <td>D:/Copy1/Ahmed_Saeed\Test.xlsx</td>
    </tr>
  </tbody>
</table>
</div>
...
<table border="1" class="dataframe">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>2024-08-11 10:53 AM</td>
      <td>.xlsx</td>
      <td>D:/Copy/Ali_Saeed\Test_1.xlsx</td>
    </tr>
  </tbody>
</table>
</div>
...
with pd.ExcelWriter("04_Example.xlsx",date_format = 'dd-mm-yyyy',datetime_format='dd-mm-yyyy') as writer:
    ...
    file_info_source_directory0.to_excel(writer, sheet_name='Source0',index=False)
    file_info_source_directory1.to_excel(writer, sheet_name='Source1',index=False)
