...
The purpose of this code is to copy **all files(of any type)** from a specified source directory and its subdirectories to a target folder, with a **size limit** of less than **500KB**. It performs the following tasks:
...
if not os.path.exists(source_directory):
    ...
    file_paths = [file for file in glob(f'{source_directory}/**/*.*',recursive=True) if os.path.getsize(file) < 500 * 1024]
...
```
    ...
    Total number of files copied: 32
