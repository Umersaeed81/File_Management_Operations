...
The objective of this code is to filter files from the source directory's subdirectories (excluding the main directory) that were modified within the last day and copy those files to a specified destination folder
