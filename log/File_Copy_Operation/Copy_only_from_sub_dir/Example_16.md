...
This example demonstrates filtering and copying files based on multiple keywords (in this case, **"US"** or **"AS"**) present in their filenames from a source directory to a destination directory, including handling files within the directory. 
...
if not os.path.exists(source_directory):
    ...
    file_paths = set(file for pattern in patterns for file in glob(f'{source_directory}/**/{pattern}',recursive=False))
