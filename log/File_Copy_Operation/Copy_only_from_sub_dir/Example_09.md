...
The purpose of this code is to copy files from a from the subdirectories of a specified source directory, but not from the source directory itself, that have a prefix of **"US"** and a **size less than 500KB** to a target folder. Here’s a breakdown of its functionality:
...
with pd.ExcelWriter("09_Example.xlsx",date_format = 'dd-mm-yyyy',datetime_format='dd-mm-yyyy') as writer:
