...
The purpose of this code is to copy **all files(of any type)** from a specified source directory to a target folder, with a **size limit** of less than **500KB**. It performs the following tasks:
...
![](https://github.com/Umersaeed81/File_Management_Operations/blob/main/log/File_Copy_Operation/copy_example_fig/Example-19.png?raw=true)
...
if not os.path.exists(source_directory):
    ...
    file_paths = [file for file in glob(f'{source_directory}/*.*') if os.path.getsize(file) < 500 * 1024]
...
with pd.ExcelWriter("34_Example.xlsx",date_format = 'dd-mm-yyyy',datetime_format='dd-mm-yyyy') as writer:
