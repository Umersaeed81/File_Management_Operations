...
The purpose of this code is to copy **all files( (of any type)** from a specified **source directory** to a target folder. It performs the following tasks:
...
if not os.path.exists(source_directory):
    ...
    file_paths = glob(f'{source_directory}/*.*')
