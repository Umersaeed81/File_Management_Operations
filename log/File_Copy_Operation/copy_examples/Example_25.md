...
The purpose of this code is to copy files with a suffix of either **"US"** or **"AS"** and a **size smaller than 500KB** from a specified source directory to a target folder. Here’s a breakdown of its functionality:
...
with pd.ExcelWriter("54_Example.xlsx",date_format = 'dd-mm-yyyy',datetime_format='dd-mm-yyyy') as writer:
