...
This example focuses on copying files from a source directory to a destination directory based on whether the files start with a specific prefix (in this case, **"US"** or **"AS"**) and have a specific file extension (in this case, **.txt** or **.xlsx**). Here’s a detailed summary:
...
![](https://github.com/Umersaeed81/File_Management_Operations/blob/main/log/File_Copy_Operation/copy_example_fig/Example-14.png?raw=true)
...
if not os.path.exists(source_directory):
    ...
    patterns = [f'{source_directory}{base_pattern}{extension}' for base_pattern, extension in product(base_patterns, extensions)]
    # Construct the file paths
    file_paths = set(file for pattern in patterns for file in glob(pattern))
