...
if not os.path.exists(source_directory):
    ...
    file_paths = [file for file in glob(f'{source_directory}/US*.txt') if os.path.getsize(file) < 500 * 1024]
...
with pd.ExcelWriter("46_Example.xlsx",date_format = 'dd-mm-yyyy',datetime_format='dd-mm-yyyy') as writer:
