...
if not os.path.exists(source_directory):
    ...
    file_paths = set([file for pattern in patterns for file in glob(f'{source_directory}/{pattern}') if os.path.getsize(file) < 500 * 1024])
...
with pd.ExcelWriter("56_Example.xlsx",date_format = 'dd-mm-yyyy',datetime_format='dd-mm-yyyy') as writer:
