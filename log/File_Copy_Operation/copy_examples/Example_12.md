...
This example demonstrates filtering and copying files based on multiple keywords (in this case, **US**,**AS**) present in their filenames from a source directory to a destination directory, including handling files within the directory. 
