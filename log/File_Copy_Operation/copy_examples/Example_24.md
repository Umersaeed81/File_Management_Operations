...
The purpose of this code is to copy files from a specified source directory that have a suffix of **"US"** and a **size less than 500KB** to a target folder. Here’s a breakdown of its functionality:
...
with pd.ExcelWriter("42_Example.xlsx",date_format = 'dd-mm-yyyy',datetime_format='dd-mm-yyyy') as writer:
